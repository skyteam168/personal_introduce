...
const knowledgeBase: KnowledgeEntry[] = [
  {
    keywords: ["项目", "project", "dự án", "做过", "built", "portfolio", "作品"],
    answer: {
      ...
      vi: "Các dự án chính của Xiaowei:\n\n1. **AI Agent OS** — Hệ điều hành Agent tự xây dựng\n2. **RAG Knowledge System** — Retrieval-augmented generation cấp doanh nghiệp\n3. **Enterprise Infrastructure Platform** — Mạng, server, datacenter & giám sát\n4. **ITSM Intelligent Ops** — Nền tảng vận hành full-stack\n5. **ERP Intelligence Upgrade** — ERP sản xuất nâng cấp AI\n6. **Production AI** — Triển khai AI production\n\nKết hợp kỹ năng phát triển AI sâu với nền tảng vận hành IT infrastructure vững chắc.",
    },
  },
  {
    ...
    answer: {
      ...
      vi: "**AI Agent OS** của Xiaowei là hệ điều hành Agent hoàn chỉnh:\n\nKiến trúc: User → AI Agent → Planner → MCP → Skills → Redis Memory → LLM → Result\n\nTech: Python, FastAPI, Redis, MCP, OpenClaw\n\nHỗ trợ orchestration đa mô hình, tool calling, memory và mở rộng Skills.",
    },
  },
  {
    keywords: ["技能", "skill", "kỹ năng", "技术", "tech", "stack", "能力", "năng lực"],
    answer: {
      ...
      vi: "Năng lực kỹ thuật chính:\n\n**Vận hành & Hạ tầng**\n- Linux / Windows Server\n- VMware, Docker\n- Zabbix, Shell/Python automation\n\n**Mạng**\n- Cisco / Huawei switch, router, firewall\n- Kiến trúc mạng, VLAN, VPN / SD-WAN\n- Nginx reverse proxy & load balancing\n\n**AI & Phát triển**\n- AI Agent, RAG, MCP\n- Python, FastAPI, Vue, Redis\n- OpenAI, Claude, DeepSeek, Qwen\n\n9+ năm, từ kỹ sư mạng đến IT Leader.",
    },
  },
  {
    keywords: ["运维", "ops", "vận hành", "服务器", "server", "机房", "datacenter", "硬件", "hardware"],
    answer: {
      ...
      vi: "Kinh nghiệm vận hành IT & hạ tầng của Xiaowei:\n\n- **Server Ops**: Quản trị Linux / Windows, tuning, patching\n- **Ảo hóa**: VMware cluster, phân bổ tài nguyên, DR backup\n- **Datacenter**: Lắp rack server, storage, UPS, cáp & quản lý tài sản\n- **Giám sát**: Hệ thống 7×24 với Zabbix + Grafana\n- **Tự động hóa**: Python / Shell cho triển khai hàng loạt & tự phục hồi\n\nHiện là IT Leader cho hạ tầng campus sản xuất nước ngoài.",
    },
  },
  {
    keywords: ["网络", "network", "mạng", "网工", "交换机", "switch", "防火墙", "firewall", "路由"],
    answer: {
      ...
      vi: "Năng lực kỹ sư mạng của Xiaowei:\n\n- Chứng chỉ **Network Engineer (Intermediate)**\n- Kiến trúc mạng ba tầng doanh nghiệp\n- Cisco / Huawei core switch, router, firewall\n- VLAN, routing, wireless\n- Đường truyền xuyên biên giới, VPN / SD-WAN\n- Chẩn đoán sự cố, tối ưu liên kết & chính sách bảo mật\n\nBắt đầu từ kỹ sư mạng năm 2015 — mạng là nền tảng kỹ thuật cốt lõi.",
    },
  },
  {
    keywords: ["经历", "experience", "kinh nghiệm", "工作", "work", "职业", "career", "背景", "hành trình"],
    answer: {
      ...
      vi: "Lộ trình nghề nghiệp:\n\n- **2020 — Nay | IT Leader, Shenzhou International**\n  Kiến trúc mạng, ảo hóa server, datacenter, giám sát, AI Platform, ERP/MES\n\n- **2017 — 2020 | Senior IT Engineer**\n  Linux/Windows ops, switch/firewall, storage/UPS, automation\n\n- **2015 — 2017 | Network Engineer**\n  Mạng ba tầng, triển khai thiết bị, cáp/rack, chứng chỉ Network Engineer\n\nTừ cáp rack đến AI Agent — hành trình hạ tầng + trí tuệ hoàn chỉnh.",
    },
  },
  {
    keywords: ["联系", "contact", "liên hệ", "邮箱", "email", "github", "微信", "wechat"],
    answer: {
      ...
      vi: `Liên hệ:\n\n- 📧 Email: ${personalInfo.email}\n- 📘 Facebook: ${personalInfo.facebook}\n- 🔗 GitHub: ${personalInfo.github}\n- 💼 LinkedIn: ${personalInfo.linkedin}\n- 💬 WeChat: quét mã QR ở mục Contact\n\nƯu tiên email hoặc WeChat.`,
    },
  },
  {
    keywords: ["证书", "certificate", "chứng chỉ", "认证", "语言", "language", "ngôn ngữ", "软考"],
    answer: {
      zh: "证书与语言：\n\n- 网络工程师（中级，软考）\n- 软件设计师（中级，软考）\n- 系统架构设计师（高级，备考中）\n- 英语 CET-4、越南语 B1\n- AWS 认证（计划中）",
      ...
      vi: "Chứng chỉ & ngôn ngữ:\n\n- Network Engineer Intermediate (Trung Quốc)\n- Software Designer Intermediate (Trung Quốc)\n- System Architect Advanced (đang chuẩn bị)\n- Tiếng Anh CET-4, Tiếng Việt B1\n- AWS Certification (dự kiến)",
    },
  },
  {
    keywords: ["架构", "architecture", "kiến trúc", "设计", "design", "mcp", "redis"],
    answer: {
      ...
      vi: "Kiến trúc AI Agent OS:\n\n```\nUser → AI Agent → Planner → MCP → Skills → Redis Memory → LLM → Result\n```\n\nVề hạ tầng, đã lãnh đạo mạng campus (core-aggregation-access), cụm VMware, backup storage & giám sát thống nhất Zabbix.",
    },
  },
  {
    keywords: ["谁", "who", "ai", "介绍", "about", "giới thiệu", "是谁", "杨晓伟", "xiaowei"],
    answer: {
      zh: "杨晓伟（Xiaowei Yang）是一位 **Enterprise AI Solutions Architect**，拥有 9+ 年企业 IT 经验。\n\n职业路径：基础设施工程师（网管）→ IT 负责人 → 网络工程师 → AI 研发工程师 → 企业数字化与信息化主导人。\n\n核心竞争力：同时具备企业 IT 基础设施、网络架构、生产级 AI Agent 与企业数字化落地经验 — 能独立负责基础设施建设，并用 AI 提升企业效率。",
      en: "Xiaowei Yang is an **Enterprise AI Solutions Architect** with 9+ years of enterprise IT experience.\n\nCareer arc: Infrastructure Engineer (SysAdmin) → IT Leader → Network Engineer → AI R&D Engineer → Head of Enterprise Digitalization & IT.\n\nCore differentiator: enterprise IT infrastructure, network architecture, production AI Agents, and digital transformation — in one practitioner who can own infrastructure end-to-end and apply AI at scale.",
      vi: "Xiaowei Yang là **Enterprise AI Solutions Architect** với 9+ năm kinh nghiệm IT doanh nghiệp.\n\nLộ trình: Kỹ sư hạ tầng → IT Leader → Kỹ sư mạng → Kỹ sư R&D AI → Lãnh đạo số hóa & CNTT doanh nghiệp.\n\nĐiểm khác biệt: hạ tầng IT, kiến trúc mạng, AI Agent production và chuyển đổi số — trong một practitioner có thể phụ trách hạ tầng end-to-end và triển khai AI quy mô lớn.",
    },
  },
];

const defaultAnswer: Localized = {
  ...
  vi: "Cảm ơn câu hỏi! Tôi có thể giúp về dự án, kinh nghiệm vận hành & mạng, kỹ năng AI, lộ trình nghề nghiệp và liên hệ của Xiaowei. Thử hỏi: \"Kinh nghiệm vận hành server?\" hoặc \"Dự án mạng đã làm?\"",
};
...
export function getAIResponse(query: string, locale: Locale): string {
  ...
  if (bestMatch && bestScore > 0) {
    return pick(bestMatch.answer, locale);
  }

  return pick(defaultAnswer, locale);
}
